...
(function () {
  ...
  function update() {
    ...
    var Hs = vh * (mob ? 0.40 : 0.50), Ws = Hs * 0.82;  // small (portrait) target
    ...
    word.style.top = (mob ? (T + H) : vh * 0.595) + "px";   // mobile: wordmark straddles the bottom of the video (overlap)
    word.style.transform = "translateY(" + (-50 + (1 - wt) * 6) + "%)";
    loc.style.opacity = clamp((p - 0.34) / 0.30, 0, 1);
    loc.style.top = (vh * (mob ? 0.64 : 0.805)) + "px";
...
(function () {
  ...
  var IMAGES = [
    { img:"/photos/BWPlus_Ivywall_21_Boodle_Platter.jpg",    css:"top:9%;left:4%;width:clamp(200px,21vw,350px);height:clamp(155px,23vh,285px);z-index:2;",   fx:-130,fy:-20, tag:"Boodle <b>feast</b>" },
    { img:"/photos/BWPlus_Ivywall_10_Signature_Seafood.jpg", css:"top:9%;right:4%;width:clamp(200px,21vw,350px);height:clamp(155px,23vh,285px);z-index:2;",  fx:130, fy:-20, tag:"Seafood <b>paella</b>" },
    { img:"/photos/BWPlus_Ivywall_22_Banana_Cocktail.jpg",   css:"top:37%;left:1.5%;width:clamp(140px,15vw,235px);height:clamp(195px,31vh,330px);z-index:5;", fx:-150,fy:0,  tag:"Calamansi <b>&amp; coconut</b>" },
    { img:"/photos/BWPlus_Ivywall_07_Restaurant.jpg",        css:"bottom:8%;left:8%;width:clamp(195px,20vw,320px);height:clamp(140px,20vh,235px);z-index:3;", fx:-60, fy:90, tag:"" },
    { img:"/photos/BWPlus_Ivywall_19_Alon_Dining_Alt.jpg",   css:"bottom:8%;right:8%;width:clamp(195px,20vw,320px);height:clamp(140px,20vh,235px);z-index:3;",fx:60,  fy:90, tag:"Alon <b>all-day</b>" },
    { img:"/photos/BWPlus_Ivywall_09_Rooftop_Bar_Night.jpg", css:"top:37%;right:1.5%;width:clamp(140px,15vw,235px);height:clamp(195px,31vh,330px);z-index:5;",fx:150, fy:0,  tag:"Teraza <b>rooftop</b>" }
  ];
