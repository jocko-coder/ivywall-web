...
(function () {
  ...
  function update() {
    ...
    word.style.top = (vh * (mob ? 0.52 : 0.595)) + "px";   // higher, so the video frame overlaps the top of the word
