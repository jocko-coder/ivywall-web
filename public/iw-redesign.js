...
(function () {
  ...
  var built=false, sectionEl=null, slideLayer=null, slideEls=[], imgEls=[], headEl=null, cueEl=null, ctaEl=null, raf=0, sIdx=0, sTimer=0, pfs=[];
  function build() {
    ...
    pfs=imgEls.map(function(el){var z=parseInt(getComputedStyle(el).zIndex)||3;return 0.05+z*0.032;});
    built=true;
  ...
  function update() {
    ...
    for (var i=0;i<imgEls.length;i++){
      ...
      imgEls[i].style.transform = "translate("+tx.toFixed(1)+"px,"+(ty+par).toFixed(1)+"px) scale("+sc.toFixed(3)+")";
    }
