...
(function(){
  ...
  try{
    if(!document.getElementById("iwx-core-css")){
      ...
      /* footer */
      '#iwf{position:relative;background:#F5700A;color:#fff;margin-top:clamp(70px,10vh,120px);font-family:"Hanken Grotesk",system-ui,sans-serif}',
      '#iwf .fx-cta{padding:clamp(84px,12vh,150px) 0 clamp(40px,6vh,70px);text-align:center}',
      '#iwf .fx-eyebrow{font-size:11px;font-weight:700;letter-spacing:.32em;text-transform:uppercase;color:#ffe2c4}',
      '#iwf .fx-h{font-family:"Cormorant Garamond",Georgia,serif;font-weight:500;font-size:clamp(40px,6vw,84px);line-height:.98;margin:18px auto 30px;color:#fff;max-width:14ch}',
      '#iwf .fx-h em{font-style:italic;font-weight:400;color:#ffe2c4}',
      '#iwf .fx-btns{display:flex;gap:14px;justify-content:center;flex-wrap:wrap}',
      '#iwf .fx-btn{display:inline-flex;align-items:center;border-radius:999px;padding:15px 30px;font:600 12px/1 "Hanken Grotesk",sans-serif;letter-spacing:.18em;text-transform:uppercase;text-decoration:none;transition:all .3s}',
      '#iwf .fx-btn.solid{background:#fff;color:#C4540A}',
      '#iwf .fx-btn.solid:hover{background:#ffe2c4}',
      '#iwf .fx-btn.line{border:1px solid rgba(255,255,255,.55);color:#fff}',
      '#iwf .fx-btn.line:hover{background:rgba(255,255,255,.14)}',
      '#iwf .fx-cols{display:grid;grid-template-columns:1.4fr 1fr 1fr;gap:clamp(26px,4vw,64px);padding:clamp(30px,5vh,54px) 0;border-top:1px solid rgba(255,255,255,.28)}',
      '#iwf .fx-cols h4{font-size:10.5px;font-weight:700;letter-spacing:.28em;text-transform:uppercase;color:#ffe2c4;margin:0 0 14px}',
      '#iwf .fx-cols a{display:block;color:rgba(255,255,255,.92);text-decoration:none;font-size:14px;line-height:2.05}',
      '#iwf .fx-cols a:hover{color:#ffe2c4}',
      '#iwf .fx-cols p{color:rgba(255,255,255,.92);font-size:14px;line-height:1.9;margin:0}',
      '#iwf .fx-mark{font-family:"Cormorant Garamond",Georgia,serif;font-weight:500;text-align:center;font-size:clamp(52px,9.2vw,150px);line-height:.92;letter-spacing:.05em;padding-bottom:8px;color:rgba(255,255,255,.16);user-select:none;pointer-events:none;white-space:nowrap;overflow:hidden}',
      '#iwf .fx-base{display:flex;flex-wrap:wrap;gap:10px 26px;align-items:center;justify-content:space-between;padding:20px 0 max(24px,env(safe-area-inset-bottom));border-top:1px solid rgba(255,255,255,.28);font-size:12px;color:rgba(255,255,255,.8)}',
      '#iwf .fx-base a{color:rgba(255,255,255,.8);text-decoration:none;margin-left:18px}',
  ...
  function buildFooter(){
    ...
    f.innerHTML=(window.__iwWave?window.__iwWave("#faf9f6","#F5700A","#f6a44e","#ffe2c4"):"")+
      '<div class="iwx-wrap">'+
      '<div class="fx-cta"><div class="fx-eyebrow">Plan your stay</div><h2 class="fx-h">Ready when <em>you are.</em></h2>'+
      '<div class="fx-btns"><a class="fx-btn solid" href="/book/">Book direct</a><a class="fx-btn line" href="/contact/">Talk to us</a></div></div>'+
      '<div class="fx-cols">'+
      ...
      '</div>'+
      '<div class="fx-mark" aria-hidden="true">THE IVYWALL</div>'+
  ...
  function init(){
    ...
    buildFooter(); markNav();
    try{
      var mo=new MutationObserver(function(){ if(!document.getElementById("iwf"))buildFooter(); markNav(); });
...
(function(){
  ...
  function build(){
    ...
    function show(i){cur=(i+T.length)%T.length;img.src=T[cur][0];img.alt=T[cur][1];cap.textContent=T[cur][1];}
