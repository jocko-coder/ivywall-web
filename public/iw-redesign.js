...
(function () {
  ...
  function rupd(){
    ...
    for(var i=0;i<cardEls.length;i++){
      ...
      cardEls[i].style.transform="translateY("+(-rec*12).toFixed(1)+"px) scale("+(1-rec*0.05).toFixed(3)+")";
      cardEls[i].style.filter = rec>0.02 ? "brightness("+(1-rec*0.07).toFixed(3)+")" : "none";
    }
  }
