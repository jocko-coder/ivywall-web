...
(function(){
 ...
 function fz(){ var sec=document.getElementById("iwend"); if(!sec) return;
   ...
   if(window.innerWidth<=860){ card.style.transform="none"; card.style.borderRadius="0"; return; }
   ...
   var cut=(prog-0.55)/0.45; cut=cut<0?0:(cut>1?1:cut);
