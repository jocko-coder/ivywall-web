...
(function () {
  ...
  var IMAGES = [
    { img:"/photos/BWPlus_Ivywall_21_Boodle_Platter.jpg",    css:"top:8%;left:3%;width:clamp(175px,19vw,320px);height:clamp(150px,24vh,290px);z-index:2;",   fx:-120,fy:-10, tag:"Boodle <b>feast</b>" },
    { img:"/photos/BWPlus_Ivywall_10_Signature_Seafood.jpg", css:"top:5%;left:38%;width:clamp(135px,15vw,250px);height:clamp(110px,18vh,210px);z-index:4;",  fx:0,  fy:-95, tag:"Seafood <b>paella</b>" },
    { img:"/photos/BWPlus_Ivywall_09_Rooftop_Bar_Night.jpg", css:"top:10%;right:3%;width:clamp(175px,19vw,320px);height:clamp(150px,23vh,280px);z-index:3;", fx:120, fy:-10, tag:"Teraza <b>rooftop</b>" },
    { img:"/photos/BWPlus_Ivywall_22_Banana_Cocktail.jpg",   css:"top:31%;left:9%;width:clamp(120px,13vw,205px);height:clamp(175px,30vh,320px);z-index:6;",  fx:-135,fy:0,  tag:"Calamansi <b>&amp; coconut</b>" },
    { img:"/photos/BWPlus_Ivywall_12_Morning_Teraza.jpg",    css:"top:35%;right:8%;width:clamp(150px,16vw,265px);height:clamp(165px,26vh,300px);z-index:6;", fx:135, fy:0,  tag:"Morning <b>teraza</b>" },
    { img:"/photos/BWPlus_Ivywall_07_Restaurant.jpg",        css:"bottom:6%;left:3%;width:clamp(185px,20vw,335px);height:clamp(130px,19vh,230px);z-index:3;", fx:-70, fy:95, tag:"" },
    { img:"/photos/BWPlus_Ivywall_19_Alon_Dining_Alt.jpg",   css:"bottom:9%;left:36%;width:clamp(140px,15vw,250px);height:clamp(110px,16vh,205px);z-index:5;",fx:0,  fy:115,tag:"Alon <b>all-day</b>" },
    { img:"/photos/BWPlus_Ivywall_15_Agos_Pool_Bar.jpg",     css:"bottom:6%;right:3%;width:clamp(170px,18vw,300px);height:clamp(125px,18vh,225px);z-index:3;",fx:70, fy:95, tag:"Agos <b>pool bar</b>" },
    { img:"/photos/BWPlus_Ivywall_21_Boodle_Platter.jpg",    css:"top:46%;left:30%;width:clamp(115px,12vw,195px);height:clamp(85px,12vh,150px);z-index:1;",   fx:0,  fy:35, tag:"" }
  ];
  ...
  function build() {
    ...
    var imgsHtml=IMAGES.map(function(im,i){
      return '<div class="bp-img" style="'+im.css+'--fx:'+im.fx+'px;--fy:'+im.fy+'px;transition-delay:'+(i*0.09).toFixed(2)+'s;"><img src="'+im.img+'" loading="lazy" decoding="async" alt="Local Boholano dish at The Ivywall">'+
        (im.tag?'<div class="tag">'+im.tag+'</div>':'')+'</div>';
    }).join("");
    s.innerHTML='<div class="bp-stage"><div class="bp-eyebrow">'+EYEBROW+'</div><div class="bp-ring"></div>'+imgsHtml+
...
(function(){
 "use strict";if(!(location.pathname==="/"||location.pathname==="/index.html"||location.pathname===""))return;
 var built=false;
 var MAP='<svg viewBox="0 0 600 500" fill="none" stroke="currentColor" stroke-width="1.1"><path d="M0,120 C150,92 320,138 600,84"/><path d="M0,182 C160,152 330,198 600,150"/><path d="M0,250 C180,222 340,270 600,232"/><path d="M0,330 C170,302 350,350 600,320"/><path d="M0,410 C160,382 340,430 600,402"/><circle cx="392" cy="250" r="5.5" fill="currentColor" stroke="none"/><circle cx="392" cy="250" r="24"/><circle cx="392" cy="250" r="50" opacity=".6"/><circle cx="392" cy="250" r="80" opacity=".35"/></svg>';
 var RIP='<svg viewBox="0 0 1200 60" preserveAspectRatio="none"><path fill="#dde4d5" d="M0,0 H1200 V32 L1160,46 L1120,30 L1080,45 L1040,28 L1000,48 L960,33 L920,50 L880,30 L840,45 L800,27 L760,47 L720,33 L680,49 L640,31 L600,47 L560,28 L520,44 L480,34 L440,50 L400,30 L360,45 L320,27 L280,47 L240,33 L200,49 L160,31 L120,46 L80,29 L40,44 L0,33 Z"/></svg>';
 ...
 function build(){
   ...
   s.innerHTML=
   '<div class="ie-rip">'+RIP+'</div>'+
   '<div class="ie-loc"><div class="ie-map">'+MAP+'</div><div class="ie-wrap">'+
     '<div class="ie-eyebrow rev">Find us · Alona Beach, Panglao</div>'+
     '<h2 class="ie-head rev">Five minutes from the airport.<br>A world from the everyday.</h2>'+
     '<div class="ie-grid"><div class="ie-body rev">'+
       '<p>The Ivywall sits a short drive from Panglao International — yet the moment you arrive the pace changes: palm shade, the smell of salt, and Alona Beach a few steps from the lobby.</p>'+
       '<p>Reef dives, dolphin mornings, the Chocolate Hills and the tarsiers are all within easy reach, and our front desk arranges every one of them.</p>'+
     '</div><div class="ie-facts rev">'+
     ...
     '</div></div>'+
     '<p class="ie-statement rev">Not just a place to stay — <em>a place that stays with you.</em></p>'+
   '</div></div>'+
   '<div class="ie-cta"><div class="bgimg"><img src="/photos/BWPlus_Ivywall_09_Rooftop_Bar_Night.jpg" alt="Teraza rooftop at dusk — The Ivywall"></div>'+
     '<div class="form rev"><div class="eye">Plan your stay</div><h3>Ready when<br>you are.</h3>'+
       '<div class="ie-field"><label>Name</label><input id="ie-name" type="text" placeholder="Your name"></div>'+
       '<div class="ie-field"><label>Email</label><input id="ie-email" type="email" placeholder="you@email.com"></div>'+
       '<div class="ie-field"><label>Phone</label><input id="ie-phone" type="tel" placeholder="+63 ..."></div>'+
       '<div class="ie-field"><label>Dates / preferences</label><textarea id="ie-msg" rows="2" placeholder="Tell us what you have in mind"></textarea></div>'+
       '<a href="#" id="ie-send" class="ie-send">Send request →</a>'+
     '</div></div>'+
   '<div class="ie-foot"><div class="cols">'+
     '<div class="brandcol"><div class="brand">THE IVYWALL</div><div style="font-size:12.5px;line-height:1.7;color:#8f836c">Best Western Plus<br>Alona Beach, Panglao,<br>Bohol 6340, Philippines</div></div>'+
   ...
   hideFooter();
   built=true;
   var sb=s.querySelector("#ie-send");
   if(sb) sb.addEventListener("click",function(e){ e.preventDefault();
     var g=function(id){var el=s.querySelector(id);return el?el.value.trim():"";};
     var n=g("#ie-name"),em=g("#ie-email"),ph=g("#ie-phone"),ms=g("#ie-msg");
     var subj=encodeURIComponent("Stay enquiry — "+(n||"Website"));
     var body=encodeURIComponent("Name: "+n+"\nEmail: "+em+"\nPhone: "+ph+"\n\nPreferences:\n"+ms);
     window.location.href="mailto:resa@bwplusivywall-panglao.com?subject="+subj+"&body="+body;
   });
   try{ var io=new IntersectionObserver(function(es){es.forEach(function(e){if(e.isIntersecting)e.target.classList.add("in");});},{threshold:0.12});
 ...
 function fz(){ var sec=document.getElementById("iwend"); if(!sec) return; if(!footEl||!footEl.isConnected) footEl=sec.querySelector(".ie-foot"); if(!footEl) return;
   var vh=window.innerHeight, r=footEl.getBoundingClientRect(); var prog=(vh - r.top)/(vh*0.85); prog=prog<0?0:(prog>1?1:prog);
   footEl.style.transform="scale("+(1+(1-prog)*0.07).toFixed(3)+")";
 }
 ...
 function init(){ if(!build()){ setTimeout(init,120); return; }
   window.addEventListener("scroll", onScrollFz, {passive:true}); window.addEventListener("resize", onScrollFz, {passive:true}); fz();
   try{ var mo=new MutationObserver(function(){enforce();}); mo.observe(document.querySelector("main")||document.body,{childList:true}); setTimeout(function(){try{mo.disconnect();}catch(e){}},9000);}catch(e){}
 }
